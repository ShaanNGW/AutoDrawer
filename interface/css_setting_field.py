...
# CSS Setting class -> Class
class CSSSettingField(ctk.CTkFrame):
    ...
    def __init__(self, master):
        ...
        # Set title
        self.__title_lbl = ctk.CTkLabel(master=self, text='Section 04 - Setting CSS Values', font=set.H2_FONT, anchor='w')
        ...
        # Sethorizontal Scale
        self.__horizontal_scale = ctk.IntVar(value=100)
        ...
        # Set to grid
        self.grid(column=1, row=3, padx=(5, 10), pady=(5, 5), sticky='wne')
